  ...
  useEffect(() => {
    const fetchProperties = async () => {
      ...
      try {
        ...
        // Lock query to lease properties
        queryParams.append("type", "lease");
        ...
        if (data.success) {
          ...
          setError(data.message || "Failed to load lease properties.");
        }
      } catch (err) {
    ...
    <main className="px-6 md:px-14 py-8 flex flex-col md:flex-row gap-8">
      ...
      {loading ? (
        ...
        <div className="flex-1 text-center py-16 text-gray-500 font-medium">
          No lease properties match your search criteria.
        </div>
      ) : (
